...
export const Header: FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/6 bg-zinc-950/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-350 flex-wrap items-center gap-3 px-5 py-4">
        ...
        <div className="flex h-14 min-w-55 flex-1 items-center rounded-2xl border border-white/10 bg-white/2">
        ...
        {/* order + watched — one container, split between */}
        <div className="ml-auto flex h-14 items-center gap-3 rounded-2xl border border-white/10 bg-white/2 px-3">
          {/* order (sort) */}
      ...
      {/* collapsible filters panel — tier row, then medium row */}
      <div
      ...
      >
        <div className="min-h-0 overflow-hidden">
          <div className="flex flex-row pb-4">
            {/* tier filters */}
            <div className="flex flex-wrap items-center gap-1.5 rounded-2xl border border-white/10 bg-white/2 px-3 py-2">
            ...
            {/* medium (show) filters */}
            <div className="flex flex-wrap items-center ml-auto gap-1.5 rounded-2xl border border-white/10 bg-white/2 px-3 py-2">
              <span className="mr-1 hidden text-[11px] font-medium uppercase tracking-wider text-zinc-600 sm:inline">
                MEDIUM
              </span>
